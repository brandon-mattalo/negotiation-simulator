...
const templates = [
  {
    ...
    configuration: {
      ...
      botOpeningOffer: [
        ...
        'Eligibility for annual performance bonus (up to 10%)',
      ],
  ...
  },
  {
    ...
    configuration: {
      ...
      botOpeningOffer: [
        '$50,000 per year for unlimited seats',
        '2-year minimum contract',
        'Training available for additional $5,000',
        'Standard support package included',
        '30-day termination notice with penalty fees',
      ],
  ...
  },
  {
    ...
    configuration: {
      ...
      botOpeningOffer: [
        'Prioritize Feature A for this sprint',
        'Commit to Feature B in the next sprint',
      ],
  ...
  },
  {
    ...
    configuration: {
      ...
      botOpeningOffer: [
        '$50,000 additional budget allocation (same as last year\'s increase)',
        'Requires quarterly ROI reporting',
        'Subject to mid-year review and adjustment',
      ],
      botStrategy: 'analytical',
      temperament: 8,
      difficulty: 'hard',
  ...
  },
  {
    ...
    configuration: {
      ...
      botOpeningOffer: [
        '55/45 revenue split in their favor (they get 55%)',
        '6-month pilot program with option to extend',
        'Each party covers their own costs during pilot',
